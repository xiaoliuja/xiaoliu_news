package com.xiaoliu.news.Utils;
...
public class EntityUtil {
    ...
    private final String bean_path = "D:\\笔墨屋实训\\代码\\news\\src\\main\\java";

    private final String mapper_path = "D:\\笔墨屋实训\\代码\\news\\src\\main\\java\\com\\xiaoliu\\news\\Dao";

    private final String xml_path = "D:\\笔墨屋实训\\代码\\news\\src\\main\\resources\\Mapper";// xml路径

    private final String model_package = "com.xiaoliu.news.Model";// model的包所在

    private final String dao_package = "com.xiaoliu.news.Dao";// dao的包所在
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import com.bimowu.first.utils.bean.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
